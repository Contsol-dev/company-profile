  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between p-8 bg-gray-100">
      ...
      <div className="md:w-1/2 md:ml-8 mt-8 md:mt-0">
        <h2 className="text-3xl font-bold text-cont-primary mb-4">
          About Contsolution
        </h2>
        ...
        <a
          href="/tentang"
          className="inline-block bg-cont-primary text-white px-6 py-3 rounded-lg shadow-lg font-semibold transition duration-300 ease-in-out hover:bg-cont-secondary"
        >
          Read More →
        </a>
      </div>
