    ...
    <div className="relative bg-gray-200 p-8 h-0 pb-[48%] overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
        ...
        <h1 className="xl:text-3xl lg:text-2xl md:text-xl text-lg font-bold text-white text-center mb-2 font-sans">
          Looking to Connect the Physical and Digital Worlds to Enhance Your
          Business Efficiency?
        </h1>
        ...
        <p className="xl:mx-80 lg:mx-60 md:mx-40 mx-20 xl:text-2xl lg:text-xl md:text-lg text-base text-white text-center font-sans">
          Our IoT development services offer solutions that enable your business
          to automate processes, collect real-time data, and optimize
          operations. We create innovative and customizable IoT devices,
          ensuring seamless integration with existing systems. Choose our IoT
          development services for smart and connected solutions.
        </p>
