...
export default function BowSvg({ className, fillColor = "#12335a" }: SvgProps) {
  return (
    <svg  
      xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  
      fill="none"  stroke={fillColor}  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  
